...
public sealed class ConcurrentPriorityQueue<T> : PriorityQueue<T>, IProducerConsumerCollection<T>,
                                                 IDisposable
    where T : class
{
    ...
    public ConcurrentPriorityQueue(int capacity, IComparer<T>? comparer = null) : base(
        capacity,
        comparer
    ) { }
