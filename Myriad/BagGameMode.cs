...
/// </summary>
public abstract record WhitelistGameMode : IGameMode
{
    /// <inheritdoc />
        ...
        Lazy<WordList> wordList)
    {
        ...
        var board = new Board(array, Columns);
        return board;
    }

    public abstract Board GenerateCuratedRandomBoard(Random random);
...
/// </summary>
public abstract record BagGameMode : IGameMode
{
        ...
        Lazy<WordList> wordList)
    {
        ...
        var board = new Board(array, width);
